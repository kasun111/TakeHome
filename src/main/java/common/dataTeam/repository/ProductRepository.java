...
public interface ProductRepository extends JpaRepository <Product, String>{
    ...
    List<Product> findAllByShopperIdAndCategoryAndBrand(@Param("shopperId") String shopperId, @Param("category") String category, @Param("brand") String brand, Pageable pageable);
}
